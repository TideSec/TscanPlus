...
v2.2版 【2024.07.22】 增加1300+Poc、Key认证、Host碰撞、40xBypass检测、Jwt破解和加解密、IP归属地查询等功能

v2.1版 【2024.07.01】 增加自定义被动指纹、程序中断恢复、自定义任意header信息、导出资产excel中高危标红等

v2.0版 【2024.06.18】 增加编解码功能，支持36种编解码、加解密、哈希等，Nuclei自定义poc智能匹配，针对445端口增加MS17010检测，资产分拣的收缩模式和C段分拣

v1.9版 【2024.05.28】 增加指纹探测规则8327条，总计51873条，远程下载非核心配置文件，增加主动指纹探测并可自定义，整合优化多个cms指纹

v1.8版 【2024.05.01】 密码破解功能完善及多线程优化、资产较多时的前端响应优化，增加RTSP端口破解功能，项目漏洞详情展示

v1.7版 【2024.04.16】 增加资产分拣功能，Poc检测可直接调用Nuclei、Xray、Afrog，增加自定义poc功能，IP扫描时会先探测是否存在防火墙

v1.6版 【2024.03.25】 增加项目管理流程，增强各功能模块联动，使用数据库可对所有功能和数据进行增删改查，添加js爬取功能及js敏感信息匹配

v1.5版 【2024.03.01】 增加一键检测ApiKey可用性功能，AV识别数据库更新，支持自定义添加红队命令

v1.4版 【2024.02.18】 增加网络空间探测功能模块，内置9种常见空间探测API，增加目录枚举递归限制、过滤指定长度、关键字、自定义后缀 

v1.3版 【2024.01.22】 增加密码生成功能，内置三种生成模式，增加设备弱口令查询功能，内置1.1万条记录

v1.2版 【2024.01.10】 增加子域名枚举、接口查询功能，针对非web服务的指纹识别进行优化，增加导出excel功能，完善更多右键功能
